...
<section class="bg-inicial" id="sobre">
	<div class="container">
		<div class="row">
			<div class="col-md-7">
...
<section id="praticas_home">	
	...
	<div class="container">
		...
		<div class="row">
			...
			<?php
				$loop = new WP_Query( array( 'post_type' => 'praticas', /*'orderby' => 'rand',*/ 'posts_per_page' => 8 ) );
		...
		<p style="text-align:center">
			<a class="btn" style="background-color: #014b94!important;" href="<?php echo get_site_url(); ?>/praticas">
